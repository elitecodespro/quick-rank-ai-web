...
*/
-- DropForeignKey
ALTER TABLE "ChapterSet" DROP CONSTRAINT "ChapterSet_userId_fkey";
...
-- AddForeignKey
ALTER TABLE "ChapterSet" ADD CONSTRAINT "ChapterSet_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("_id") ON DELETE RESTRICT ON UPDATE CASCADE;
